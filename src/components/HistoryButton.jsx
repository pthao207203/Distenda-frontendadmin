...
const HistoryButton = ({ onClick }) => {
  return (
    <button onClick={ onClick } className="flex gap-3 justify-center items-center md:p-[0.75rem] p-[0.25rem] rounded-lg bg-[#F19F19] w-fit hover:bg-[#D3D7DC] transition-colors">
      <img
          loading="lazy"
