      ...
      <div className="flex flex-col justify-between max-w-fit bg-[#6C8299] max-h-fit ">
        ...
        <div className="relative flex-col justify-start bg-none h-full p-[20px]">
          <div className="flex flex-col justify-center items-center mb-[5px]">
            ...
            />
            <p className="text-white mt-2 text-lg max-md:text-[13px] font-semibold">
              {userName || "Người dùng"}
            </p>
          </div>

          <div
            className="flex justify-between items-center cursor-pointer text-white max-md:text-[12px] mb-2"
          ...
          <div
            className="flex justify-between items-center cursor-pointer text-white max-md:text-[12px] mt-4 mb-2"
